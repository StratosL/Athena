/**
 * DEMO: Sessions - Persisting conversation context
 *
 * - Phase 1: Creates session, captures session_id from init message
 * - Phase 2: Resumes with "resume: sessionId" - Claude remembers previous context
 * - Phase 3: Forks with "forkSession: true" - creates NEW session branching from original
 * - Use case: multi-turn conversations, exploring alternative paths
 *
 * Run: bun run demo:sessions
 */
