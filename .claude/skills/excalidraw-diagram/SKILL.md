...
|---------------|-------------|---------------|
| **Code snippets** | APIs, integrations, implementation details | Dark rectangle (#1a1a1a) + syntax-colored text |
...
|------------------|------|--------|
| Primary/Neutral | `#6366F1` | `#312e81` |
| Secondary | `#818cf8` | `#312e81` |
| Start/Trigger | `#fed7aa` | `#c2410c` |
| End/Success | `#a7f3d0` | `#047857` |
| Warning/Reset | `#fee2e2` | `#dc2626` |
| Decision | `#fef3c7` | `#b45309` |
| AI/LLM | `#ddd6fe` | `#6d28d9` |
| Inactive/Disabled | `#c7d2fe` | `#4338ca` (dashed) |

**Brand spot accents** (use sparingly for emphasis, not as primary fills):
- Orange `#FF9000` — CTA arrows, energy, emphasis
- Cyan `#43C2D2` — data visualization, metrics

**Color on text** (light mode): Deep indigo (#312e81) for titles, indigo (#6366F1) for subtitles, gray (#64748b) for details.
**Color on text** (dark mode): Pale indigo (#c7d2fe) for titles, light indigo (#a5b4fc) for subtitles, slate (#94a3b8) for details.
...
**Light mode** (default for general use):
```json
{
  "type": "excalidraw",
  "version": 2,
...
**Dark mode** (for brand-aligned presentations, YouTube content, or dark-background contexts):
```json
{
  "type": "excalidraw",
  "version": 2,
...
When using dark mode, adjust text colors to their light-mode counterparts (see color-palette.md theme table).
